...
![Scaling](images/bldc_hall_q14_scaling.jpg)
...
![Main Task](images/bldc_hall_main_task.jpg)
...
![block_diagram](images/bldc_hall_userparam.jpg)
...
![block_diagram](images/bldc_hall_pwm_timer_setting.jpg)
...
| ----------------------- | ---------------------------------------------- |--------------------|
| mclv2_pic32cm_mc_pim.X | MPLABX project for MCLV2 board with PIC32CM MC PIM |[MCLV2 with PIC32CM MC PIM](../docs/mclv2_pic32cm_mc_pim_hall_sensor.md)|
||||
